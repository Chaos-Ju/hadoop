...
public class NMLeveldbStateStoreService extends NMStateStoreService {
  ...
  public void storeContainerPaused(ContainerId containerId) throws IOException {
    ...
    opDurations.addStoreContainerPausedStateDuration(clock.getTime() - start);
  }
  ...
  public void storeContainerDiagnostics(ContainerId containerId,
    ...
    opDurations.addStoreContainerDiagnosticsStateDuration(clock.getTime() - start);
  }
  ...
  public void storeContainerUpdateToken(ContainerId containerId,
    ...
    opDurations.addStoreContainerUpdateTokenStateDuration(clock.getTime() - start);
  }
  ...
  public void storeContainerCompleted(ContainerId containerId,
    ...
    opDurations.addStoreContainerCompletedStateDuration(clock.getTime() - start);
  }
  ...
  public void storeContainerRemainingRetryAttempts(ContainerId containerId,
    ...
    opDurations.addStoreContainerRemainingRetryAttemptsDuration(clock.getTime() - start);
  }
  ...
  public void startResourceLocalization(String user, ApplicationId appId,
    ...
    opDurations.addStoreStartResourceLocalizationDuration(clock.getTime() - start);
  }
  ...
  public void finishResourceLocalization(String user, ApplicationId appId,
    ...
    opDurations.addStoreFinishResourceLocalizationDuration(clock.getTime() - start);
  }
  ...
  public void removeLocalizedResource(String user, ApplicationId appId,
    ...
    opDurations.addRemoveLocalizedResourceStateDuration(clock.getTime() - start);
  }
  ...
  public RecoveredDeletionServiceState loadDeletionServiceState()
    ...
    opDurations.addLoadDeletionServiceStateDuration(clock.getTime() - start);
    return state;
  }
  ...
  public void storeNMTokenCurrentMasterKey(MasterKey key)
    ...
    opDurations.addStoreNMTokenCurrentMasterKeyDuration(clock.getTime() - start);
  }
  ...
  public void storeNMTokenPreviousMasterKey(MasterKey key)
    ...
    opDurations.addStoreNMTokenPreviousMasterKeyDuration(clock.getTime() - start);
  }
  ...
  public void storeNMTokenApplicationMasterKey(
    ...
    opDurations.addStoreNMTokenApplicationMasterKeyDuration(clock.getTime() - start);
  }
  ...
  public void removeNMTokenApplicationMasterKey(
    ...
    opDurations.addRemoveNMTokenApplicationMasterKeyDuration(clock.getTime() - start);
  }
  ...
  public void storeContainerTokenCurrentMasterKey(MasterKey key)
    ...
    opDurations.addStoreContainerTokenCurrentMasterKeyDuration(clock.getTime() - start);
  }
  ...
  public void storeContainerTokenPreviousMasterKey(MasterKey key)
    ...
    opDurations.addStoreContainerTokenPreviousMasterKeyDuration(clock.getTime() - start);
  }
  ...
  public void storeAMRMProxyCurrentMasterKey(MasterKey key) throws IOException {
    ...
    opDurations.addStoreAMRMProxyCurrentMasterKeyDuration(clock.getTime() - start);
  }
  ...
  public void storeAMRMProxyNextMasterKey(MasterKey key) throws IOException {
    ...
    opDurations.addStoreAMRMProxyNextMasterKeyDuration(clock.getTime() - start);
  }
  ...
  public void storeAMRMProxyAppContextEntry(ApplicationAttemptId attempt,
    ...
    opDurations.addStoreAMRMProxyAppContextEntryDuration(clock.getTime() - start);
  }
  ...
  public void removeAMRMProxyAppContextEntry(ApplicationAttemptId attempt,
    ...
    opDurations.addRemoveAMRMProxyAppContextEntryDuration(clock.getTime() - start);
  }
  ...
  public void removeAMRMProxyAppContext(ApplicationAttemptId attempt)
    ...
    opDurations.addRemoveAMRMProxyAppContextDuration(clock.getTime() - start);
  }
